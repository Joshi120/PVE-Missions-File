...
//MAS 1.5 L119CQB
  ...
  //Mod Vehicles	
  	...
  	class DAR_M1152Woodland {price = 1000;};
  	class DAR_M1152 {price = 1000;};
  	class DAR_M1151WoodlandUA {price = 1000;};
  	class DAR_H1A {price = 1000;};
  	class DAR_MaxxProPlus {price = 1000;};
  	class RHS_UH60M_MEV2_d {price = 2500;};
  	class RHS_UH60M_d {price = 2500;};
  	class RHS_UH1Y_UNARMED_d_10 {price = 2500;};
  	class RHS_UH1Y_UNARMED_10 {price = 2500;};
  	class Bell412 {price = 2500;};
  	class UH1C {price = 2500;};
  	class UH1D_1 {price = 2500;};
  	class UH1H_Closed {price = 2500;};
  	class UH1N_Black {price = 2500;};
  	class UH1Y_FFV {price = 2500;};
  	class rhs_prp3_tv {price = 2500;};
  	class rhsusf_rg33_d {price = 2500;};
  	class rhsusf_rg33_usmc_wd {price = 2500;};
  	class D_Cobalt_Blue {price = 2500;};
  	class D_Cobalt_DarkRed {price = 2500;};
  	class D_Cobalt_Granite {price = 2500;};
  	class D_Cobalt_Red {price = 2500;};
  	class D_Cobalt_White {price = 2500;};
  	class D_Cobalt_Yellow {price = 2500;};
  	class STA3_ClassFShuttle {price = 2500;};
  	class B_G_Van_01_fuel_F {price = 2500;};
  	class C_Offroad_01_repair_F {price = 2500;};
  	class BAF_Jackal2_GMG_W {price = 2500;};
  	class rhs_tigr_3camo_msv {price = 2500;};
  	class rhs_tigr_ffv_3camo_msv {price = 2500;};
  	class rhs_tigr_ffv_msv {price = 2500;};
  	class rhs_uaz_open_chdkz {price = 2500;};
  	class BAF_Merlin_HC3_DG1 {price = 2500;};
  	class sab_CU_Ambulance_Hunter {price = 2500;};
  	class sab_CU_Ambulance_Hatchback {price = 2500;};
  	class sab_CU_Ambulance_Strider {price = 2500;};
  	class IVORY_R8 {price = 2500;};
  	class IVORY_R8SPYDER {price = 2500;};
  	class sab_CU_Van_Blu {price = 2500;};
  	class sab_CU_Truck_BD {price = 2500;};
  	class sab_CU_BS_Offroad {price = 2500;};
  	class sab_CU_BS_Suv {price = 2500;};
  	class sab_CU_Pickup_CS {price = 2500;};
  	class sab_CU_Truck_CS {price = 2500;};
  	class sab_CU_BD_Hatchback {price = 2500;};
  	class sab_CU_BD_Hunter {price = 2500;};
  	class sab_CU_BD_CRV {price = 2500;};
  	class HMMWV {price = 2500;};
  	class sab_CU_NC_Hatchback {price = 2500;};
  	class O_Truck_03_device_F {price = 2500;};
